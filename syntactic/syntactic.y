...
%token TOKEN_ESCREVA TOKEN_SE TOKEN_ENTAO TOKEN_SENAO_SE TOKEN_SENAO TOKEN_FIM_SE TOKEN_ENQUANTO TOKEN_FACA TOKEN_FIM_ENQUANTO TOKEN_ERRO TOKEN_CHAMA TOKEN_CHAMADA TOKEN_RETORNA TOKEN_TIPO
...
%type <real> EXPRESSAO_MATEMATICA FATOR_MATEMATICO EXPRESSAO_BOOLEANA
...
CHAMADA_FUNCAO:
  TOKEN_CHAMA TOKEN_CHAMADA TOKEN_IDENTIFICADOR CHAMA_ARGS {
    production("CHAMADA_FUNCAO -> TOKEN_CHAMA TOKEN_CHAMADA TOKEN_IDENTIFICADOR CHAMA_ARGS")
  };
...
VARIAVEL_DECLARACAO_CORPO:
  LISTA_IDENTIFICADORES TOKEN_PONTO_E_VIRG {
    production("VARIAVEL_DECLARACAO_CORPO -> TOKEN_IDENTIFICADOR TOKEN_PONTO_E_VIRG");
  }
  | ATRIBUICAO_DECLARACAO {
...
SENAO_SE_BLOCO: 
  TOKEN_SENAO_SE SE_CABECALHO SE_CORPO SENAO_SE_BLOCO {
    production("SENAO_SE_BLOCO -> TOKEN_SENAO_SE SE_CABECALHO SE_CORPO SENAO_SE_BLOCO");
  }
  ...
  | TOKEN_SENAO_SE error TOKEN_FIM_SE {
      yyerrok;
      yyclearin;
  }
...
SE_CORPO:
  LISTA_DECLARACOES {
    production("SE_CORPO -> LISTA_DECLARACOES");
  }
  | error TOKEN_FIM_SE {
      yyerrok;
      yyclearin;
...
ENQUANTO_DECLARACAO:
  ...
  | TOKEN_ENQUANTO error TOKEN_FIM_ENQUANTO {
      yyerrok;
      yyclearin;
  };
...
OPERACAO_BINARIA:
  FATOR_MATEMATICO OPERACAO_MATEMATICA OPERACAO_BINARIA {
...
FATOR_MATEMATICO:
  ...
  | TOKEN_ABRE_PAR EXPRESSAO_MATEMATICA TOKEN_FECHA_PAR {
    production("FATOR_PRIMARIO_MATEMATICO -> TOKEN_FECHA_PAR EXPRESSAO_MATEMATICA TOKEN_FECHA_PAR");
  };
